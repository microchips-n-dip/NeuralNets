...
void SigmoidGradientFunctor::run(std::vector<Data>* inputs, std::vector<Data>* outputs)
{
...
void SigmoidFunctor::run(std::vector<Data>* inputs, std::vector<Data>* outputs)
{
...
void TanhGradientFunctor::run(std::vector<Data>* inputs, std::vector<Data>* outputs)
{
...
void HadamardProductGradientFunctor::run(std::vector<Data>* inputs, std::vector<Data>* outputs)
{
...
void HadamardProductFunctor::run(std::vector<Data>* inputs, std::vector<Data>* outputs)
{
...
void HadamardQuotientFunctor::run(std::vector<Data>* inputs, std::vector<Data>* outputs)
{
